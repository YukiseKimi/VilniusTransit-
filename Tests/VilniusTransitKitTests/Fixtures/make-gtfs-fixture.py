...
# Big enough that inflating it would be obvious, and it is never a required file.
stop_times = "trip_id,arrival_time,departure_time,stop_id,stop_sequence\n" + "".join(
    f"A7-01-6-260901-ba-1300,13:{m//60:02d}:{m%60:02d},13:{m//60:02d}:{m%60:02d},9483,{m}\n"
    for m in range(4000)
)
