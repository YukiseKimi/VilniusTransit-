...
struct TeleportTests {
    ...
    func fixIntervalWraps() {
        #expect(VehicleTrack.fixInterval(from: 49500, to: 49505) == 5)
        #expect(VehicleTrack.fixInterval(from: 86395, to: 5) == 10)
        // GTFS night services report past 24:00; 90000 is 01:00 the next day.
        #expect(VehicleTrack.fixInterval(from: 86390, to: 90000) == 3610)
        #expect(VehicleTrack.fixInterval(from: 49505, to: 49500) == nil)
    }
}
