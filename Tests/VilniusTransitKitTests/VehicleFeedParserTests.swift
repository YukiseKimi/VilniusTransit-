...
struct VehicleFeedParserTests {
    ...
    func clockFormatting() {
        #expect(VilniusTime.clockString(secondsSinceMidnight: 48685) == "13:31:25")
        #expect(VilniusTime.clockString(secondsSinceMidnight: 0) == "00:00:00")
        // GTFS service days run past 24:00 for night buses.
        #expect(VilniusTime.clockString(secondsSinceMidnight: 90000) == "01:00:00")
    }
}
